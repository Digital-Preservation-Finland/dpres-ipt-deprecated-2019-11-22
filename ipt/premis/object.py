...
class Object(lxml.etree._ElementTree):
    ...
    def environment(self):
        try:
            return self.xpath("//premis:environment",
                              namespaces=NAMESPACES)[0]
        except IndexError:
            return ""
    ...
    def dependency(self):
        try:
            return self.xpath("//premis:environment/premis:dependency",
                              namespaces=NAMESPACES)[0]
        except IndexError:
            return ""
    ...
    def dependencyIdentifier(self):
        try:
            return self.xpath(
                "//premis:environment/premis:dependency/premis:dependencyIdentifier",
                namespaces=NAMESPACES)[0]
        except IndexError:
            return ""
    ...
    def dependencyIdentifierValue(self):
        return self.xpath(
            "//premis:environment/premis:dependency/premis:dependencyIdentifier/premis:dependencyIdentifierValue/text()",
            namespaces=NAMESPACES)[0]
    ...
    def dependencyIdentifierValue(self, value):
        if value:
            ...
            element = SubElement(
                self.dependencyIdentifier, PREMIS + "dependencyIdentifierValue")
            element.text = value.decode("utf-8")
    ...
    def dependencyIdentifierType(self, value):
        if value:
            ...
            element = SubElement(
                self.dependencyIdentifier, PREMIS + "dependencyIdentifierType")
            element.text = value.decode("utf-8")

    @property
    def relationship(self):
        try:
            return self.xpath("//premis:relationship",
                              namespaces=NAMESPACES)[0]
        except IndexError:
            return ""
    ...
    def relationshipType(self, value):
        if value:
            ...
            element = SubElement(
                self.relationship, PREMIS + "relationshipType")
            element.text = value.decode("utf-8")
    ...
    def relationshipSubType(self, value):
        if value:
            element = SubElement(
                self.relationship, PREMIS + "relationshipSubType")
            element.text = value.decode("utf-8")
    ...
    def relatedObjectIdentification(self):
        try:
            return self.xpath(
                "//premis:relationship/premis:relatedObjectIdentification",
                namespaces=NAMESPACES)[0]
        except IndexError:
            return ""
    ...
    def relatedObjectIdentification(self, value):
        ...
        element = SubElement(
            self.relationship, PREMIS + "relatedObjectIdentification")
        # Note: only whitespace is allowed in this element by Premis schema
        #element.text = value.decode("utf-8")
    ...
    def relatedObjectIdentifierValue(self, value):
        if value:
            ...
            element = SubElement(
                self.relatedObjectIdentification, PREMIS + "relatedObjectIdentifierValue")
            element.text = value.decode("utf-8")
    ...
    def relatedObjectIdentifierType(self, value):
        if value:
            ...
            element = SubElement(
                self.relatedObjectIdentification, PREMIS +
    ...
    def linkingIntellectualEntityIdentifier(self):
        try:
            return self.xpath("//premis:linkingIntellectualEntityIdentifier",
                              namespaces=NAMESPACES)[0]
        except IndexError:
            return ""
    ...
    def linkingIntellectualEntityIdentifier(self, value):
        element = SubElement(
            self.root, PREMIS + "linkingIntellectualEntityIdentifier")
        # Note: only whitespace is allowed in this element by Premis schema
        #element.text = value.decode("utf-8")
    ...
    def linkingIntellectualEntityIdentifierValue(self, value):
        if value:
            element = SubElement(
                self.linkingIntellectualEntityIdentifier, PREMIS + "linkingIntellectualEntityIdentifierValue")
            element.text = value.decode("utf-8")
