...
class Event(lxml.etree._ElementTree):
    """
        ...
        class which can encapsulate multiple events and serialize them all at once.
        ...
        .. code-block:: xml
            ...
            <premis:event>
                ...
                <premis:eventDateTime>2013-11-19T17:58:04</premis:eventDateTime>
    ...
    def eventIdentifier(self):
        try: return self.xpath("//premis:eventIdentifier",
    ...
    def eventIdentifierValue(self):
        try: return self.xpath("//premis:eventIdentifier/premis:eventIdentifierValue/text()",
                               namespaces=NAMESPACES)[0]
        except IndexError: return ""
    
    @eventIdentifierValue.setter
    def eventIdentifierValue(self, value):
        element = SubElement(self.eventIdentifier, PREMIS + "eventIdentifierValue" )
        element.text = value.decode("utf-8")
        
    @property
    def eventIdentifierType(self):
        return self.xpath("//premis:eventIdentifier/premis:eventIdentifierType/text()",
                          namespaces=NAMESPACES)[0]
        
    @eventIdentifierType.setter
    def eventIdentifierType(self, value):
        if value:
            element = SubElement(self.eventIdentifier, PREMIS + "eventIdentifierType" )
            element.text = value.decode("utf-8")
    
    @property
    def eventType(self):
        try: return self.xpath("//premis:eventType/text()",
                               namespaces=NAMESPACES)[0]
        except IndexError: return ""
    ...
    def eventDetail(self):
        try: return self.xpath("//premis:eventDetail/text()",
                               namespaces=NAMESPACES)[0]
        except IndexError: return ""
    ...
    def eventOutcomeInformation(self):
        try: return self.xpath("//premis:eventOutcomeInformation",
                               namespaces=NAMESPACES)[0]
        except IndexError:
    ...
    def eventOutcomeInformation(self, value):
        element = SubElement(self.getroot(), PREMIS + "eventOutcomeInformation" )
        element.text = value.decode("utf-8")
    
    @property
    def eventOutcome(self):
        return self.xpath("//premis:eventOutcomeInformation/premis:eventOutcome/text()",
                          namespaces=NAMESPACES)[0]
    
    @eventOutcome.setter
    def eventOutcome(self, value):
        element = SubElement(self.eventOutcomeInformation, PREMIS + "eventOutcome" )
        element.text = value.decode("utf-8")
    
    @property
    def eventOutcomeDetail(self):
        try: return self.xpath("//premis:eventOutcomeInformation/premis:eventOutcomeDetail",
                               namespaces=NAMESPACES)[0]
        except IndexError:
            self.eventOutcomeDetail = ""
            return self.xpath("//premis:eventOutcomeInformation/premis:eventOutcomeDetail",
                              namespaces=NAMESPACES)[0]

    @eventOutcomeDetail.setter
    def eventOutcomeDetail(self, value):
        element = SubElement(self.eventOutcomeInformation, PREMIS + "eventOutcomeDetail" )
        # Note: only whitespace is allowed in this element by Premis schema
        # element.text = value.decode("utf-8")
    
    @property
    def eventOutcomeDetailNote(self):
        try: return self.xpath("//premis:eventOutcomeInformation/premis:eventOutcomeDetail/premis:eventOutcomeDetailNote",
                               namespaces=NAMESPACES)[0]
        except IndexError: return ""
    ...
    def eventOutcomeDetailNote(self, value):
        if value:
            element = SubElement(self.eventOutcomeDetail, PREMIS + "eventOutcomeDetailNote" )
            element.text = value.decode("utf-8")

    @property
    def eventOutcomeDetailExtension(self):
        try: return self.xpath("//premis:eventOutcomeInformation/premis:eventOutcomeDetail/premis:eventOutcomeDetailExtension", namespaces=NAMESPACES)[0]
        except IndexError:
    ...
    def eventOutcomeDetailExtension(self, value):
        try:
            parser = lxml.etree.XMLParser(dtd_validation=False, no_network=True)
            tree = lxml.etree.fromstring(value)
            
            element = SubElement(self.eventOutcomeDetail, PREMIS + "eventOutcomeDetailExtension" )
    ...
    def linkingObjectIdentifier(self):
        try: return self.xpath("//premis:linkingObjectIdentifier",
                        namespaces=NAMESPACES)[0]
        except IndexError:
    ...
    def linkingObjectIdentifier(self, value):
        element = SubElement(self.getroot(), PREMIS + "linkingObjectIdentifier" )
        element.text = ""
    ...
    def linkingObjectIdentifierType(self):
        ...
        return self.xpath("//premis:linkingObjectIdentifier/premis:linkingObjectIdentifierType/text()",
                          namespaces=NAMESPACES)[0]
    ...
    def linkingObjectIdentifierType(self, value):
        if value:
            element = SubElement(self.linkingObjectIdentifier, PREMIS + "linkingObjectIdentifierType" )
            element.text = value.decode("utf-8")
    
    @property
    def linkingObjectIdentifierValue(self):
        try: return self.xpath("//premis:linkingObjectIdentifier/premis:linkingObjectIdentifierValue/text()",
                               namespaces=NAMESPACES)[0]
        except IndexError: return ""
    ...
    def linkingObjectIdentifierValue(self, value):
        if value:
            element = SubElement(self.linkingObjectIdentifier, PREMIS + "linkingObjectIdentifierValue" )
            element.text = value.decode("utf-8")
    
    @property
    def linkingAgentIdentifier(self):
        try: return self.xpath("//premis:linkingAgentIdentifier",
                               namespaces=NAMESPACES)[0]
        except IndexError:
    ...
    def linkingAgentIdentifierType(self):
        return self.xpath("//premis:linkingAgentIdentifier/premis:linkingAgentIdentifierType/text()",
                          namespaces=NAMESPACES)[0]
    
    @linkingAgentIdentifierType.setter
    def linkingAgentIdentifierType(self, value):
        element = SubElement(self.linkingAgentIdentifier, PREMIS + "linkingAgentIdentifierType" )
        element.text = value.decode("utf-8")
    
    @property
    def linkingAgentIdentifierValue(self):
        try: return self.xpath("//premis:linkingAgentIdentifier/premis:linkingAgentIdentifierValue/text()",
                               namespaces=NAMESPACES)[0]
        except IndexError: return ""
    
    @linkingAgentIdentifierValue.setter
    def linkingAgentIdentifierValue(self, value):
        element = SubElement(self.linkingAgentIdentifier, PREMIS + "linkingAgentIdentifierValue" )
        element.text = value.decode("utf-8")
    ...
    def fromvalidator(self, returnstatus = 0, messages = "", errors = "", linkingObject = None, linkingAgent = None):
        self.eventIdentifier = ""
        ...
        else: self.eventOutcome = "failure"
