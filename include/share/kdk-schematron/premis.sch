...
-->
	...
	<sch:let name="mimeVersion" value="exsl:node-set('2.0.1') | exsl:node-set('1.0 1.1') | exsl:node-set('1.0') | exsl:node-set('4.01') | exsl:node-set('1.0') | exsl:node-set('1.0') | exsl:node-set('1.0') | exsl:node-set('1.0') | exsl:node-set('1.0') | exsl:node-set('A-1a A-1b A-2a A-2b A-2u 1.2 1.3 1.4 1.5 1.6 1.7') | exsl:node-set('8859-15 UTF-8 UTF-16 UTF-32 utf-8 utf-16 utf-32') | exsl:node-set('1.3') | exsl:node-set('2') | exsl:node-set('1.2.1') | exsl:node-set('') | exsl:node-set('') | exsl:node-set('') | exsl:node-set('') | exsl:node-set('1.00 1.01 1.02') | exsl:node-set('') | exsl:node-set('6.0 1.3') | exsl:node-set('1.2') | exsl:node-set('') | exsl:node-set('8.0 8.5 9.0 10.0 11.0 12.0 14.0') | exsl:node-set('8.0 9.0 10.0 11.0 12.0 14.0') | exsl:node-set('8.0 9.0 10.0 11.0 12.0 14.0') | exsl:node-set('') | exsl:node-set('9') | exsl:node-set('') | exsl:node-set('1 2 4') | exsl:node-set('9') | exsl:node-set('3.0') | exsl:node-set('1987a 1989a') | exsl:node-set('1.0 1.1')"/>
	...
	<sch:let name="pronom" value="exsl:node-set('fmt/483') | exsl:node-set('fmt/102 fmt/103') | exsl:node-set('fmt/101') | exsl:node-set('fmt/100') | exsl:node-set('fmt/136') | exsl:node-set('fmt/137') | exsl:node-set('fmt/138') | exsl:node-set('fmt/140') | exsl:node-set('fmt/139') | exsl:node-set('fmt/95 fmt/354 fmt/476 fmt/477 fmt/478 fmt/16 fmt/17 fmt/18 fmt/19 fmt/20 fmt/276') | exsl:node-set('x-fmt/111') | exsl:node-set('x-fmt/135 x-fmt/136') | exsl:node-set('fmt/2') | exsl:node-set('fmt/279') | exsl:node-set('') | exsl:node-set('fmt/141') | exsl:node-set('fmt/337') | exsl:node-set('fmt/392') | exsl:node-set('fmt/42 fmt/43 fmt/44') | exsl:node-set('x-fmt/392') | exsl:node-set('fmt/353 fmt/438') | exsl:node-set('fmt/13') | exsl:node-set('fmt/289') | exsl:node-set('fmt/40 fmt/412') | exsl:node-set('fmt/61 fmt/62 fmt/214') | exsl:node-set('fmt/126 fmt/215') | exsl:node-set('fmt/134') | exsl:node-set('fmt/132') | exsl:node-set('x-fmt/152') | exsl:node-set('x-fmt/386 fmt/199') | exsl:node-set('fmt/133') | exsl:node-set('fmt/124') | exsl:node-set('fmt/3 fmt/4') | exsl:node-set('x-fmt/219 fmt/410')"/>
