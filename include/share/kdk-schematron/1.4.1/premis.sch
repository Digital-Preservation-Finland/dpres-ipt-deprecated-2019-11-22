...
-->
	...
	<sch:let name="mimeVersion" value="exsl:node-set('2.0.1') | exsl:node-set('1.0 1.1') | exsl:node-set('1.0') | exsl:node-set('4.01') | exsl:node-set('1.0') | exsl:node-set('1.0') | exsl:node-set('1.0') | exsl:node-set('1.0')  | exsl:node-set('1.0') | exsl:node-set('A-1a A-1b A-2a A-2b A-2u 1.2 1.3 1.4 1.5 1.6 1.7') | exsl:node-set('ISO-8859-15 UTF-8 UTF-16 UTF-32 iso-8859-15 utf-8 utf-16 utf-32') | exsl:node-set('1.3') | exsl:node-set('2') | exsl:node-set('1.2.1 1.3.0') | exsl:node-set('') | exsl:node-set('') | exsl:node-set('') | exsl:node-set('') | exsl:node-set('1.00 1.01 1.02') | exsl:node-set('') | exsl:node-set('6.0 1.3') | exsl:node-set('1.2') | exsl:node-set('') | exsl:node-set('8.0 8.5 9.0 10.0 11.0 12.0 14.0') | exsl:node-set('8.0 9.0 10.0 11.0 12.0 14.0') | exsl:node-set('8.0 9.0 10.0 11.0 12.0 14.0') | exsl:node-set('') | exsl:node-set('9') | exsl:node-set('') | exsl:node-set('1 2 4') | exsl:node-set('9') | exsl:node-set('3.0') | exsl:node-set('1987a 1989a') | exsl:node-set('1.0 1.1') | exsl:node-set('12.0 14.0') | exsl:node-set('12.0 14.0') | exsl:node-set('12.0 14.0')"/>
